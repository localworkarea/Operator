 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".cards-a__slider")) new Swiper(".cards-a__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 500,
            ...
            if (document.querySelector(".cards-b__slider")) new Swiper(".cards-b__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".more-servs__slider")) new Swiper(".more-servs__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        document.addEventListener("DOMContentLoaded", (function() {
                    ...
                    menuItems.forEach((menuItem => {
                        ...
                        if (isMobile.any()) {
                            menuLink.addEventListener("click", (() => {
                                if (menuItem.classList.contains("_show-sub-menu")) menuItem.classList.remove("_show-sub-menu"); else menuItem.classList.add("_show-sub-menu");
                            }));
                            document.addEventListener("click", (e => {
                                if (!menuItem.contains(e.target)) menuItem.classList.remove("_show-sub-menu");
                            }));
                        } else {
            ...
            spollers.forEach((spoller => {
                ...
                if (wrapperSpollers.length) wrapperSpollers.forEach(((wrapper, index) => {
                    wrapper.style.setProperty("--index", index);
                }));
                if (wrapperSpollerFaqs.length) wrapperSpollerFaqs.forEach(((wrapper, index) => {
                    wrapper.style.setProperty("--index", index);
                }));
                if (listsItem.length) listsItem.forEach(((wrapper, index) => {
                    wrapper.style.setProperty("--index", index);
                }));
            }));
            ...
            if (selectOptions) {
                ...
                observer.observe(selectOptions, {
                    attributes: true
                });
